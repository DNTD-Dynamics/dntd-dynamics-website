...
- **Commercial deployment license** — covers one deployed system under the Business Source License commercial-use grant
- **Production radar configuration** — the validated tuning that holds tracking on a person down to ~0.35 m at close range, where the public example profile loses them near 0.5 m
...
**I bought a license — do I need another one for the board?**
The board includes its own license for the system it's deployed on. A standalone license covers a system you build on your own hardware.

**Is this FCC certified?**
Not yet. The board sells as a development kit for evaluation and development use — the same basis on which every silicon vendor's evaluation module is sold. An FCC-certified production module is the planned next step, driven by demand from this first run.

**What if Q4 slips?**
Then I'll tell you, plainly, before you read it anywhere else — and your deposit is refundable in full at any point. You're never charged the balance until hardware is actually shipping.

**Can I see it working before I buy?**
Yes — the demo video, the lab notes, and the full source. That's the point of building this in the open.
